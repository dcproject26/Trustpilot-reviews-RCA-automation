...
def main():
    ...
    try:
        ...
        s.add(RcaDraft(id="d2", review_id="tp_demo_2", match_tier=2,
                       ...
                       # Shaped exactly as _make_candidate builds them. These
                       # used to carry only id / experienceName / date_of_visit,
                       # which no real path produces, so the demo showed
                       # candidate cards with no guest, no vendor and no match
                       # reasons - the three things an associate chooses on.
                       candidates_list=[
                           {"id": "8840012", "primary_guest_name": "D. Whitmore",
                            "experience": "Carrières des Lumières",
                            "experienceName": "Carrières des Lumières",
                            "experience_name": "Carrières des Lumières",
                            "date_of_visit": "2026-03-08", "visitDate": "2026-03-08",
                            "experienceDate": "2026-03-08", "bookedOn": "2026-03-01",
                            "vendorName": "Culturespaces", "tgid": "24680",
                            "tid": "13579", "vid": "9753",
                            "matched_on": ["venue", "visit date 2026-03-08"],
                            "matchReasons": ["venue", "visit date 2026-03-08"],
                            "narrowing_path": "indicator_shortlist",
                            "amountUSD": 74.0, "_score": 0.62, "score": None},
                           {"id": "8839887", "primary_guest_name": "David W.",
                            "experience": "Carrières des Lumières",
                            "experienceName": "Carrières des Lumières",
                            "experience_name": "Carrières des Lumières",
                            "date_of_visit": "2026-03-09", "visitDate": "2026-03-09",
                            "experienceDate": "2026-03-09", "bookedOn": "2026-03-02",
                            "vendorName": "Culturespaces", "tgid": "24680",
                            "tid": "13579", "vid": "9753",
                            "matched_on": ["venue"], "matchReasons": ["venue"],
                            "narrowing_path": "indicator_shortlist",
                            "amountUSD": 74.0, "_score": 0.55, "score": None},
                       ],
